...
var _Chadtech$gulp_elm_boilerplate$Util$viewIf = F2(
	function (condition, html) {
		return condition ? html : _elm_lang$html$Html$text('');
	});
var _Chadtech$gulp_elm_boilerplate$Util$enterDecoder = F2(
	function (msg, code) {
...
var _Chadtech$gulp_elm_boilerplate$Util$onEnter = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
		A2(
			_elm_lang$core$Json_Decode$andThen,
			_Chadtech$gulp_elm_boilerplate$Util$enterDecoder(msg),
			_elm_lang$html$Html_Events$keyCode));
};
var _Chadtech$gulp_elm_boilerplate$Util$contains = _elm_lang$core$Basics$flip(_elm_lang$core$List$member);
var _Chadtech$gulp_elm_boilerplate$Util$maybeCons = F2(
	function (maybe, list) {
		var _p0 = maybe;
		if (_p0.ctor === 'Just') {
...
var _Chadtech$gulp_elm_boilerplate$Util_ops = _Chadtech$gulp_elm_boilerplate$Util_ops || {};
_Chadtech$gulp_elm_boilerplate$Util_ops['&'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _Chadtech$gulp_elm_boilerplate$Util_ops = _Chadtech$gulp_elm_boilerplate$Util_ops || {};
...
var _Chadtech$gulp_elm_boilerplate$Ports$toJs = _elm_lang$core$Native_Platform.outgoingPort(
	'toJs',
	function (v) {
		return v;
	});
var _Chadtech$gulp_elm_boilerplate$Ports$sendToJs = function (msg) {
	var _p0 = msg;
	return _Chadtech$gulp_elm_boilerplate$Ports$toJs(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: A2(
					_Chadtech$gulp_elm_boilerplate$Util_ops[':='],
					'type',
					_elm_lang$core$Json_Encode$string('console log')),
				_1: {
					ctor: '::',
					_0: A2(
						_Chadtech$gulp_elm_boilerplate$Util_ops[':='],
...
var _Chadtech$gulp_elm_boilerplate$Ports$fromJs = _elm_lang$core$Native_Platform.incomingPort('fromJs', _elm_lang$core$Json_Decode$value);
var _Chadtech$gulp_elm_boilerplate$Ports$ConsoleLog = function (a) {
	return {ctor: 'ConsoleLog', _0: a};
};
var _Chadtech$gulp_elm_boilerplate$Ports$ConsoleLogHappened = {ctor: 'ConsoleLogHappened'};
var _Chadtech$gulp_elm_boilerplate$Ports$receiveMsgDecoder = F2(
	function (json, string) {
		var _p1 = string;
		if (_p1 === 'console log happened') {
			return _elm_lang$core$Json_Decode$succeed(_Chadtech$gulp_elm_boilerplate$Ports$ConsoleLogHappened);
		} else {
			return _elm_lang$core$Json_Decode$fail('Not a valid receive msg type');
		}
	});
var _Chadtech$gulp_elm_boilerplate$Ports$receive = function (json) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		_Chadtech$gulp_elm_boilerplate$Ports$receiveMsgDecoder(json),
		A2(_elm_lang$core$Json_Decode$field, 'type', _elm_lang$core$Json_Decode$string));
};
var _Chadtech$gulp_elm_boilerplate$Ports$decodeReceiveMsg = function (json) {
	return A2(
		_elm_lang$core$Json_Decode$decodeValue,
		_Chadtech$gulp_elm_boilerplate$Ports$receive(json),
		json);
};

var _Chadtech$gulp_elm_boilerplate$Types$init = {field: '', timesEnterWasPressed: 0};
var _Chadtech$gulp_elm_boilerplate$Types$Model = F2(
	function (a, b) {
		return {field: a, timesEnterWasPressed: b};
	});
var _Chadtech$gulp_elm_boilerplate$Types$HandleJsMsg = function (a) {
	return {ctor: 'HandleJsMsg', _0: a};
};
var _Chadtech$gulp_elm_boilerplate$Types$EnterHappened = {ctor: 'EnterHappened'};
var _Chadtech$gulp_elm_boilerplate$Types$UpdateField = function (a) {
...
var _Chadtech$gulp_elm_boilerplate$Styles_Shared$red = _rtfeldman$elm_css$Css$hex('#f21d23');
var _Chadtech$gulp_elm_boilerplate$Styles_Shared$lightGray = _rtfeldman$elm_css$Css$hex('#d0b5a9');
var _Chadtech$gulp_elm_boilerplate$Styles_Shared$offWhite = _rtfeldman$elm_css$Css$hex('#f9fcfb');
var _Chadtech$gulp_elm_boilerplate$Styles_Shared$almostWhite = _rtfeldman$elm_css$Css$hex('#fcf7f9');
var _Chadtech$gulp_elm_boilerplate$Styles_Shared$almostBlack = _rtfeldman$elm_css$Css$hex('#030907');
var _Chadtech$gulp_elm_boilerplate$Styles_Shared$appNameSpace = 'app-name';
var _Chadtech$gulp_elm_boilerplate$Styles_Shared$Big = {ctor: 'Big'};
var _Chadtech$gulp_elm_boilerplate$Styles_Shared$Point = {ctor: 'Point'};
var _Chadtech$gulp_elm_boilerplate$Styles_Shared$Field = {ctor: 'Field'};

var _Chadtech$gulp_elm_boilerplate$Styles$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _Chadtech$gulp_elm_boilerplate$Styles_Shared$appNameSpace, _p0));
}(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css_Elements$body(
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$backgroundColor(_Chadtech$gulp_elm_boilerplate$Styles_Shared$almostWhite),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				_Chadtech$gulp_elm_boilerplate$Styles_Shared$Field,
				{
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$color(_Chadtech$gulp_elm_boilerplate$Styles_Shared$almostBlack),
						_1: {
							ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$backgroundColor(_Chadtech$gulp_elm_boilerplate$Styles_Shared$offWhite),
								_1: {
									ctor: '::',
									_0: A3(
										...
										_Chadtech$gulp_elm_boilerplate$Styles_Shared$lightGray),
									_1: {
										ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_Chadtech$gulp_elm_boilerplate$Styles_Shared$Point,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$fontFamilies(
							{
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									_Chadtech$gulp_elm_boilerplate$Styles_Shared$Big,
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$fontSize(
...
var _Chadtech$gulp_elm_boilerplate$View$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(_Chadtech$gulp_elm_boilerplate$Styles_Shared$appNameSpace);
var _Chadtech$gulp_elm_boilerplate$View$id = _Chadtech$gulp_elm_boilerplate$View$_p0.id;
var _Chadtech$gulp_elm_boilerplate$View$class = _Chadtech$gulp_elm_boilerplate$View$_p0.$class;
var _Chadtech$gulp_elm_boilerplate$View$classList = _Chadtech$gulp_elm_boilerplate$View$_p0.classList;
var _Chadtech$gulp_elm_boilerplate$View$title = A2(
	_elm_lang$html$Html$p,
	{
		ctor: '::',
		_0: _Chadtech$gulp_elm_boilerplate$View$class(
			{
				ctor: '::',
				_0: _Chadtech$gulp_elm_boilerplate$Styles_Shared$Point,
				_1: {
					ctor: '::',
					_0: _Chadtech$gulp_elm_boilerplate$Styles_Shared$Big,
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
...
var _Chadtech$gulp_elm_boilerplate$View$inputField = function (str) {
	return A2(
		_elm_lang$html$Html$input,
		{
			...
			_0: _Chadtech$gulp_elm_boilerplate$View$class(
				{
					ctor: '::',
					_0: _Chadtech$gulp_elm_boilerplate$Styles_Shared$Field,
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_Chadtech$gulp_elm_boilerplate$Types$UpdateField),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder('Press enter to console log msg'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$spellcheck(false),
							_1: {
								ctor: '::',
								_0: _Chadtech$gulp_elm_boilerplate$Util$onEnter(_Chadtech$gulp_elm_boilerplate$Types$EnterHappened),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _Chadtech$gulp_elm_boilerplate$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _Chadtech$gulp_elm_boilerplate$View$title,
			_1: {
				ctor: '::',
				_0: _Chadtech$gulp_elm_boilerplate$View$inputField(model.field),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$p,
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(model.timesEnterWasPressed)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _Chadtech$gulp_elm_boilerplate$Main$handleRecieveMsg = F2(
	function (receiveMsg, model) {
		var _p0 = receiveMsg;
		return A2(_Chadtech$gulp_elm_boilerplate$Util_ops['&'], model, _elm_lang$core$Platform_Cmd$none);
	});
var _Chadtech$gulp_elm_boilerplate$Main$update = F2(
		...
		switch (_p1.ctor) {
			...
			case 'EnterHappened':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{timesEnterWasPressed: model.timesEnterWasPressed + 1}),
					_Chadtech$gulp_elm_boilerplate$Ports$sendToJs(
						_Chadtech$gulp_elm_boilerplate$Ports$ConsoleLog(model.field)));
			default:
				if (_p1._0.ctor === 'Ok') {
					return A2(_Chadtech$gulp_elm_boilerplate$Main$handleRecieveMsg, _p1._0._0, model);
				} else {
					return A2(_Chadtech$gulp_elm_boilerplate$Util_ops['&'], model, _elm_lang$core$Platform_Cmd$none);
				}
		}
	});
var _Chadtech$gulp_elm_boilerplate$Main$subscriptions = function (_p2) {
	return _Chadtech$gulp_elm_boilerplate$Ports$fromJs(
		function (_p3) {
			return _Chadtech$gulp_elm_boilerplate$Types$HandleJsMsg(
				_Chadtech$gulp_elm_boilerplate$Ports$decodeReceiveMsg(_p3));
		});
};
var _Chadtech$gulp_elm_boilerplate$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _Chadtech$gulp_elm_boilerplate$Types$init, _1: _elm_lang$core$Platform_Cmd$none},
		view: _Chadtech$gulp_elm_boilerplate$View$view,
		update: _Chadtech$gulp_elm_boilerplate$Main$update,
		subscriptions: _Chadtech$gulp_elm_boilerplate$Main$subscriptions
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _Chadtech$gulp_elm_boilerplate$Main$main !== 'undefined') {
    _Chadtech$gulp_elm_boilerplate$Main$main(Elm['Main'], 'Main', undefined);
}
